...
.. |DaskJQ| replace:: Dask Jobqueue Docs
.. _DaskJQ: https://jobqueue.dask.org/en/latest/
.. |DaskD| replace:: Dask Distributed Docs
.. _DaskD: http://distributed.dask.org/en/latest/
.. |ParslDoc| replace:: Parsl Docs
.. _ParslDoc: https://parsl.readthedocs.io/en/latest/index.html
"""
...
htmlhelp_basename = 'QCFractaldoc'
...
# -- Keywords for manual page output ------------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [
    (master_doc, 'qcfractal', 'QCFractal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QCFractal', 'QCFractal Documentation',
     author, 'QCFractal', 'One line description of project.',
     'Miscellaneous'),
]
